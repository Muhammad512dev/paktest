...
import { DollarSign, TrendingUp, CreditCard, ArrowUpRight, ArrowDownRight, Calendar, Plus, X, Search, Filter } from 'lucide-react';
            ...
            <table className="w-full text-left whitespace-nowrap">
                ...
                <tbody className="divide-y divide-gray-100">
                    ...
                    {filteredTransactions.length === 0 && (
                        <tr>
                            <td colSpan={6} className="px-6 py-12 text-center text-gray-400 italic">No transactions found matching criteria.</td>
                        </tr>
                    )}
                </tbody>
            </table>
