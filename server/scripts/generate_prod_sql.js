...
async function exportSql() {
  ...
  const outputPath = path.join(__dirname, '..', '..', 'import_pctb_books_production.sql');
  fs.writeFileSync(outputPath, sql, 'utf8');
  console.log(`Successfully generated import_pctb_books_production.sql at ${outputPath} with ${books.length} records.`);
}
