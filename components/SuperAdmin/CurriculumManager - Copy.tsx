...
const CurriculumManager: React.FC = () => {
  ...
  const handleAddItem = async () => {
    ...
    let logoStr = '';
    if (newItemImage) logoStr = await fileToBase64(newItemImage);
              ...
              <div className="flex-1 overflow-auto">
                 <table className="w-full text-left border-collapse">
                    <thead className="bg-slate-50 border-b border-gray-200 sticky top-0 z-10 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                       <tr><th className="px-6 py-4">{'Board > Grade'}</th><th className="px-6 py-4">Subject</th><th className="px-6 py-4">{'Chapter > Topic'}</th>
</tr>
