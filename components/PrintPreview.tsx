                                   ...
                                   {q.options.map((opt, i) => (
                                     <div key={i} className="flex gap-1 items-baseline">
                                        ...
                                        {isManualEdit ? 
                                            ...
                                            <MathRenderer text={opt} className={`text-[11px] font-medium truncate ${showAnswersInline && opt === q.correctAnswer ? 'font-bold underline text-green-700 decoration-green-500' : ''}`} inline />
                                        }
                                     </div>
                                   ))}
                                </div>
